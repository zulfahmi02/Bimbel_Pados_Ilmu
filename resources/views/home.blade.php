    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300">
                ...
                <p class="text-gray-700 italic">"Nilai matematika anak saya meningkat drastis setelah ikut bimbel di sini. Gurunya sabar dan cara mengajarnya mudah dipahami!"</p>
            </div>
