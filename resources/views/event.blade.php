            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($pastEvents as $event)
                        <div
                            class="bg-white rounded-xl shadow-md hover:shadow-lg transition duration-300 overflow-hidden opacity-90">
                            @if($event->image)
                            ...
                            <div class="p-5">
                                ...
                                <a href="{{ route('event.show', $event->slug) }}" 
                                   class="inline-block text-emerald-600 font-semibold hover:text-emerald-700 transition duration-300">
                                    Selengkapnya →
                                </a>
                            </div>
                        </div>
