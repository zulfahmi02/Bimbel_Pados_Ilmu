                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($schedule->teacher && $schedule->teacher->whatsapp)
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $schedule->teacher->whatsapp) }}" 
                                       target="_blank"
                                       class="inline-flex items-center gap-2 px-3 py-2 bg-green-500 hover:bg-green-600 text-white rounded-md transition duration-300 shadow-md hover:shadow-lg"
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-emerald-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-4 text-left text-xs font-semibold text-emerald-700 uppercase tracking-wider">Kontak</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
