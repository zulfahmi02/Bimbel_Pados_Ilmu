...
@section('title', 'Blog - Bimbel Pados Ilmu')

@section('description', 'Baca artikel-artikel menarik seputar pendidikan, tips belajar, dan informasi terkini dari Bimbel Pados Ilmu.')
                    ...
                    <article class="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 overflow-hidden">
                        @if($post->image)
                            <div class="h-48 overflow-hidden">
                                <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->title }}" class="w-full h-full object-cover hover:scale-105 transition duration-300">
                            </div>
                        @else
                        ...
                        <div class="p-6">
                            ...
                            <a href="{{ route('blog.show', $post->slug) }}" class="inline-flex items-center text-emerald-600 font-semibold hover:text-emerald-700 transition duration-300">
                                Baca Selengkapnya
